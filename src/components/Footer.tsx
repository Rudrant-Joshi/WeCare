      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1 space-y-4">
            <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => setTab('home')}>
              <div className="w-10 h-10 rounded-xl bg-teal-500 flex items-center justify-center text-white shadow-md shadow-teal-900/50">
          ...
          <div>
            ...
            <ul className="space-y-3.5 text-sm">
              <li>
                <button 
                  onClick={() => setTab('home')} 
                  className="hover:text-teal-400 transition-colors text-slate-400 cursor-pointer text-left"
                >
                  Home Page
                </button>
              </li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+15551012000" className="text-slate-300 hover:text-white font-medium transition-colors">
                  +1 (555) 101-2000
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-teal-400 shrink-0" />
                <a href="mailto:info@wecarehospitals.com" className="text-slate-300 hover:text-white transition-colors">
            ...
            <div className="pt-4">
              <button
                ...
                id="footer-cta-book"
                className="w-full inline-flex items-center justify-center gap-2 bg-teal-600 hover:bg-teal-500 text-white text-sm font-semibold py-3 px-4 rounded-xl transition-all shadow-md active:scale-95 cursor-pointer"
              >
        ...
        <div className="mt-16 pt-8 border-t border-slate-800 text-center md:flex md:justify-between md:items-center text-xs text-slate-500">
          ...
          <div className="mt-4 md:mt-0 flex justify-center gap-6">
            ...
            <a href="#" className="hover:text-slate-400 transition-colors">Patient Bill of Rights</a>
          </div>
        </div>
      </div>
    </footer>
