          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              <motion.div 
                ...
                className="inline-flex items-center gap-2 bg-teal-50 border border-teal-100 rounded-full px-4 py-1.5 text-teal-700 text-xs font-semibold uppercase tracking-wider animate-pulse-glow"
              >
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="bg-teal-600 hover:bg-teal-700 text-white font-medium px-8 py-4 rounded-xl shadow-lg shadow-teal-100 transition-all hover:shadow-teal-200 cursor-pointer flex items-center justify-center gap-2 btn-shine"
                >
                  Book Appointment
              ...
              >
                {[
                  ...
                  <motion.div 
                    ...
                    className="stat-hover cursor-default"
                  >
                    <h4 className="text-3xl font-extrabold text-slate-900 font-sans">{stat.value}</h4>
            ...
            <div className="lg:col-span-5 relative">
              <motion.div 
                ...
                className="relative rounded-3xl bg-teal-600 p-8 text-white shadow-2xl shadow-teal-900/10 overflow-hidden min-h-[420px] flex flex-col justify-between animate-breathe"
              >
                {/* Decorative glow */}
                <div className="absolute -right-12 -top-12 w-64 h-64 bg-teal-500 rounded-full blur-2xl opacity-40 animate-float" />
                <div className="absolute -left-12 -bottom-12 w-64 h-64 bg-emerald-500 rounded-full blur-2xl opacity-40 animate-float-delayed" />
                ...
                <div className="relative z-10 pt-4 border-t border-white/20 flex items-center justify-between text-xs text-teal-100">
                  ...
                  <a href="tel:+15551012000" className="text-white hover:underline font-bold flex items-center gap-1 link-hover-underline">
                    Call Center
              ...
              <motion.div 
                ...
                className="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-xl border border-gray-100 hidden sm:flex items-center gap-3 z-20 animate-float-delayed"
              >
                <div className="w-10 h-10 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center icon-hover-bounce">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <StaggerItem>
            <motion.div 
              whileHover={{ y: -6 }}
              className="bg-white p-6.5 rounded-2xl border border-gray-100 shadow-sm card-hover group"
            >
              <div className="w-11 h-11 bg-teal-50 text-teal-600 rounded-xl flex items-center justify-center mb-5 icon-hover-rotate">
                <Stethoscope className="w-5.5 h-5.5" />
              </div>
              <h3 className="text-slate-950 font-bold text-base mb-2 group-hover:text-teal-600 transition-colors">Qualified Specialists</h3>
          ...
          <StaggerItem>
            <motion.div 
              ...
              className="bg-white p-6.5 rounded-2xl border border-gray-100 shadow-sm card-hover group"
            >
              <div className="w-11 h-11 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center mb-5 icon-hover-rotate">
                <Activity className="w-5.5 h-5.5" />
              </div>
              <h3 className="text-slate-950 font-bold text-base mb-2 group-hover:text-teal-600 transition-colors">Advanced Diagnostics</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
          ...
          <StaggerItem>
            <motion.div 
              ...
              className="bg-white p-6.5 rounded-2xl border border-gray-100 shadow-sm card-hover group"
            >
              <div className="w-11 h-11 bg-emerald-50 text-emerald-600 rounded-xl flex items-center justify-center mb-5 icon-hover-rotate">
                <Clock className="w-5.5 h-5.5" />
              </div>
              <h3 className="text-slate-950 font-bold text-base mb-2 group-hover:text-teal-600 transition-colors">24/7 Emergency Wing</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
          ...
          <StaggerItem>
            <motion.div 
              ...
              className="bg-white p-6.5 rounded-2xl border border-gray-100 shadow-sm card-hover group"
            >
              <div className="w-11 h-11 bg-amber-50 text-amber-600 rounded-xl flex items-center justify-center mb-5 icon-hover-rotate">
                <HeartPulse className="w-5.5 h-5.5" />
              </div>
              <h3 className="text-slate-950 font-bold text-base mb-2 group-hover:text-teal-600 transition-colors">Empathetic Patient Care</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" staggerDelay={0.12}>
            {DEPARTMENTS.slice(0, 3).map((dept) => (
              <StaggerItem key={dept.id}>
                <motion.div 
                  whileHover={{ y: -6 }}
                  className="bg-white rounded-2xl border border-gray-200/60 overflow-hidden shadow-sm card-hover flex flex-col justify-between h-full group"
                >
                  <div className="p-6 text-left">
                    <div className="w-11 h-11 bg-teal-50 text-teal-600 rounded-xl flex items-center justify-center mb-4 icon-hover-bounce">
                      {getIcon(dept.iconName)}
                    </div>
                    <h3 className="text-lg font-bold text-slate-900 mb-2 group-hover:text-teal-600 transition-colors">{dept.name}</h3>
                  ...
                  <div className="px-6 py-4 bg-slate-50 border-t border-gray-100 flex items-center justify-between text-xs">
                    ...
                    <button
                      onClick={() => setTab('departments')}
                      className="text-teal-600 hover:text-teal-700 font-bold flex items-center gap-1 group/btn"
                    >
                      Services & Doctors
          ...
          {featuredDoctors.map((doc) => {
            ...
            return (
              <StaggerItem key={doc.id}>
                <motion.div 
                  whileHover={{ y: -6 }}
                  className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col justify-between card-hover group text-left h-full"
                >
            ...
            {TESTIMONIALS.map((t) => (
              <StaggerItem key={t.id}>
                <motion.div 
                  ...
                  className="bg-slate-800/65 border border-slate-800 p-6 rounded-2xl space-y-4 text-left flex flex-col justify-between testimonial-hover h-full"
                >
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8" staggerDelay={0.12}>
          {latestTips.map((tip) => (
            <StaggerItem key={tip.id}>
              <motion.article 
                whileHover={{ y: -6 }}
                className="bg-white rounded-2xl border border-gray-100 p-6.5 text-left flex flex-col justify-between card-hover h-full group"
              >
                <div className="space-y-4">
                  ...
                  <h3 className="font-sans font-extrabold text-base text-slate-900 leading-snug group-hover:text-teal-600 transition-colors">
                    {tip.title}
                  </h3>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollAnimate variant="scaleUp">
          <div className="bg-gradient-to-r from-teal-500 to-indigo-600 rounded-3xl p-8 md:p-12 text-white text-center md:text-left flex flex-col md:flex-row md:items-center justify-between gap-8 relative overflow-hidden shadow-xl">
            {/* Background shapes */}
            <div className="absolute -left-12 -top-12 w-48 h-48 bg-teal-400 rounded-full blur-2xl opacity-20 animate-float" />
            <div className="absolute -right-12 -bottom-12 w-48 h-48 bg-indigo-500 rounded-full blur-2xl opacity-20 animate-float-delayed" />
            ...
            <div className="relative z-10 shrink-0 flex flex-col sm:flex-row gap-4 items-center justify-center">
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="w-full sm:w-auto bg-white text-slate-900 hover:bg-slate-50 font-bold px-7 py-3.5 rounded-xl text-sm shadow-md flex items-center justify-center gap-2 cursor-pointer btn-shine"
              >
