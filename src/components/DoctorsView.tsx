  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-left" id="doctors-view">
        ...
        <div className="bg-slate-50 rounded-2xl p-4 sm:p-6 mb-8 border border-slate-150 flex flex-col md:flex-row gap-4 items-center justify-between shadow-sm">
          ...
          <div className="relative w-full md:max-w-md">
            ...
            <input
              ...
              className="pl-10 w-full bg-white rounded-xl border border-gray-200 py-2.5 px-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-teal-100 focus:border-teal-500 transition-all"
            />
            {searchTerm && (
              <button 
      ...
      {filteredDoctors.length > 0 ? (
        <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" staggerDelay={0.08} id="doctors-roster-grid">
          {filteredDoctors.map((doc) => {
            ...
            return (
              <StaggerItem key={doc.id}>
                <motion.div
                  whileHover={{ y: -6 }}
                  className="bg-white rounded-2xl border border-gray-150 overflow-hidden flex flex-col justify-between card-hover group cursor-pointer h-full"
                ...
                >
                  ...
                  <div className="px-5 pb-5 space-y-4">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      <span className="text-[10px] text-teal-600 font-semibold flex items-center gap-1 group-hover:translate-x-1 transition-transform">
            ...
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 border-t border-gray-100 pt-5 text-xs text-slate-600">
                  ...
                  <div className="space-y-1">
                    ...
                    <a 
                      ...
                      className="font-semibold text-teal-600 hover:underline flex items-center gap-1 mt-0.5 link-hover-underline"
                    >
              ...
              <div className="px-6 py-4 bg-slate-50 border-t border-gray-100 flex items-center justify-end gap-3">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.96 }}
                  className="bg-teal-600 hover:bg-teal-700 text-white text-xs font-bold py-2.5 px-5 rounded-xl shadow-sm flex items-center gap-1.5 cursor-pointer btn-shine"
                >
